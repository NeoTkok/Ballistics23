...
class CelestialGravity {
    [[nodiscard]] Vector3d calcAccelerationSingleBody(const Vector3d &relativePosition,
...
public:
    ...
    [[nodiscard]] Vector3d calcAcceleration(const TimeModule::Time<TimeModule::TimeScale::TT_SCALE> &timeTT,
        ...
        const Vector3d moonAcceleration =
            calcAccelerationSingleBody(positionGCRS - inputParams.moonPositionGCRS, inputParams.moonGravParameter);
        ...
        const Vector3d sunAcceleration =
            calcAccelerationSingleBody(positionGCRS - inputParams.sunPositionGCRS, inputParams.sunGravParameter);
