...
Matrix3<scalar> FrameConverter<PolarMotionContainer, DutContainer>::conversionMatrixGCRStoITRS(
    ...
    const TimeModule::Time<TimeModule::TimeScale::UT1_SCALE> ut1 = timeConverter_.convertTT_UT1(tt);
    ...
    const TimeModule::Time<TimeModule::TimeScale::UTC_SCALE> utc = timeConverter_.convertUT1_UTC(ut1);
    ...
    resultMatrix << static_cast<scalar>(rc2it[0][0]), static_cast<scalar>(rc2it[0][1]),
        static_cast<scalar>(rc2it[0][2]), static_cast<scalar>(rc2it[1][0]), static_cast<scalar>(rc2it[1][1]),
        static_cast<scalar>(rc2it[1][2]), static_cast<scalar>(rc2it[2][0]), static_cast<scalar>(rc2it[2][1]),
