...
template <typename DutContainer> class TimeConverter {
  DutContainer dutContainer_;

  template <TimeScale Scale> static constexpr bool AlwaysFalse = false;
...
scalar TimeConverter<DutContainer>::dtr(
    const Time<TimeScale::TT_SCALE> &tt) const noexcept {

  return static_cast<scalar>(iauDtdb(static_cast<double>(tt.jdDayInt()),
                                     static_cast<double>(tt.jdDayFrac()), 0, 0,
                                     0, 0));
}

template <typename DutContainer>
TimeConverter<DutContainer>::TimeConverter(
    const DutContainer &dutContainer) noexcept
    : dutContainer_(dutContainer) {}

template <typename DutContainer>
Time<TimeScale::UTC_SCALE> TimeConverter<DutContainer>::convertUT1_UTC(
    const Time<TimeScale::UT1_SCALE> &ut1) const {

  double jdIntUTC = ut1.jdDayInt(), jdFracUTC = ut1.jdDayFrac();
  for (indexType i = 0; i < 3; ++i) {

    const int status =
        iauUt1utc(static_cast<double>(ut1.jdDayInt()),
                  static_cast<double>(ut1.jdDayFrac()),
...
template <typename DutContainer>
Time<TimeScale::TAI_SCALE> TimeConverter<DutContainer>::convertUT1_TAI(
    const Time<TimeScale::UT1_SCALE> &ut1) const {
...
template <typename DutContainer>
Time<TimeScale::TT_SCALE> TimeConverter<DutContainer>::convertUT1_TT(
    const Time<TimeScale::UT1_SCALE> &ut1) const {
...
template <typename DutContainer>
Time<TimeScale::TCG_SCALE> TimeConverter<DutContainer>::convertUT1_TCG(
    const Time<TimeScale::UT1_SCALE> &ut1) const {
...
template <typename DutContainer>
Time<TimeScale::TDB_SCALE> TimeConverter<DutContainer>::convertUT1_TDB(
    const Time<TimeScale::UT1_SCALE> &ut1) const {
...
template <typename DutContainer>
Time<TimeScale::TCB_SCALE> TimeConverter<DutContainer>::convertUT1_TCB(
    const Time<TimeScale::UT1_SCALE> &ut1) const {
...
template <typename DutContainer>
Time<TimeScale::TAI_SCALE> TimeConverter<DutContainer>::convertUTC_TAI(
    const Time<TimeScale::UTC_SCALE> &utc) const {

  double jdIntTAI, jdFracTAI;

  const int status =
      iauUtctai(static_cast<double>(utc.jdDayInt()),
                static_cast<double>(utc.jdDayFrac()), &jdIntTAI, &jdFracTAI);
...
template <typename DutContainer>
Time<TimeScale::UT1_SCALE> TimeConverter<DutContainer>::convertUTC_UT1(
    const Time<TimeScale::UTC_SCALE> &utc) const {

  double jdIntUT1, jdFracUT1;

  const int status = iauUtcut1(static_cast<double>(utc.jdDayInt()),
                               static_cast<double>(utc.jdDayFrac()),
...
template <typename DutContainer>
Time<TimeScale::TT_SCALE> TimeConverter<DutContainer>::convertUTC_TT(
    const Time<TimeScale::UTC_SCALE> &utc) const {
...
template <typename DutContainer>
Time<TimeScale::TCG_SCALE> TimeConverter<DutContainer>::convertUTC_TCG(
    const Time<TimeScale::UTC_SCALE> &utc) const {
...
template <typename DutContainer>
Time<TimeScale::TCB_SCALE> TimeConverter<DutContainer>::convertUTC_TCB(
    const Time<TimeScale::UTC_SCALE> &utc) const {
...
template <typename DutContainer>
Time<TimeScale::TDB_SCALE> TimeConverter<DutContainer>::convertUTC_TDB(
    const Time<TimeScale::UTC_SCALE> &utc) const {
...
Time<TimeScale::UTC_SCALE> TimeConverter<DutContainer>::convertTAI_UTC(
  ...
  const int status =
      iauTaiutc(static_cast<double>(tai.jdDayInt()),
                static_cast<double>(tai.jdDayFrac()), &jdIntTAI, &jdFracTAI);
...
template <typename DutContainer>
Time<TimeScale::TT_SCALE> TimeConverter<DutContainer>::convertTAI_TT(
    const Time<TimeScale::TAI_SCALE> &tai) const {

  scalar jdIntTT, jdFracTT;

  const int status =
      iauTaitt(tai.jdDayInt(), tai.jdDayFrac(), &jdIntTT, &jdFracTT);
...
template <typename DutContainer>
Time<TimeScale::TCG_SCALE> TimeConverter<DutContainer>::convertTAI_TCG(
    const Time<TimeScale::TAI_SCALE> &tai) const {
...
template <typename DutContainer>
Time<TimeScale::TCB_SCALE> TimeConverter<DutContainer>::convertTAI_TCB(
    const Time<TimeScale::TAI_SCALE> &tai) const {
...
template <typename DutContainer>
Time<TimeScale::TDB_SCALE> TimeConverter<DutContainer>::convertTAI_TDB(
    const Time<TimeScale::TAI_SCALE> &tai) const {
...
template <typename DutContainer>
Time<TimeScale::UTC_SCALE> TimeConverter<DutContainer>::convertTT_UTC(
    const Time<TimeScale::TT_SCALE> &tt) const {
...
template <typename DutContainer>
Time<TimeScale::UT1_SCALE> TimeConverter<DutContainer>::convertTT_UT1(
    const Time<TimeScale::TT_SCALE> &tt) const {
...
template <typename DutContainer>
Time<TimeScale::TAI_SCALE> TimeConverter<DutContainer>::convertTT_TAI(
    const Time<TimeScale::TT_SCALE> &tt) const {

  scalar jdIntTAI, jdFracTAI;

  const int status =
      iauTttai(tt.jdDayInt(), tt.jdDayFrac(), &jdIntTAI, &jdFracTAI);
...
template <typename DutContainer>
Time<TimeScale::TCG_SCALE> TimeConverter<DutContainer>::convertTT_TCG(
    const Time<TimeScale::TT_SCALE> &tt) const {

  scalar jdIntTCG, jdFracTCG;

  const int status =
      iauTttcg(tt.jdDayInt(), tt.jdDayFrac(), &jdIntTCG, &jdFracTCG);
...
template <typename DutContainer>
Time<TimeScale::TCB_SCALE> TimeConverter<DutContainer>::convertTT_TCB(
    const Time<TimeScale::TT_SCALE> &tt) const {
...
template <typename DutContainer>
Time<TimeScale::TDB_SCALE> TimeConverter<DutContainer>::convertTT_TDB(
    const Time<TimeScale::TT_SCALE> &tt) const {

  scalar jdIntTDB, jdFracTDB;
  const int status =
      iauTttdb(tt.jdDayInt(), tt.jdDayFrac(), dtr(tt), &jdIntTDB, &jdFracTDB);
...
template <typename DutContainer>
Time<TimeScale::UTC_SCALE> TimeConverter<DutContainer>::convertTCG_UTC(
    const Time<TimeScale::TCG_SCALE> &tcg) const {
...
template <typename DutContainer>
Time<TimeScale::UT1_SCALE> TimeConverter<DutContainer>::convertTCG_UT1(
    const Time<TimeScale::TCG_SCALE> &tcg) const {
...
template <typename DutContainer>
Time<TimeScale::TAI_SCALE> TimeConverter<DutContainer>::convertTCG_TAI(
    const Time<TimeScale::TCG_SCALE> &tcg) const {
...
template <typename DutContainer>
Time<TimeScale::TT_SCALE> TimeConverter<DutContainer>::convertTCG_TT(
    const Time<TimeScale::TCG_SCALE> &tcg) const {

  scalar jdIntTT, jdFracTT;

  const int status =
      iauTcgtt(tcg.jdDayInt(), tcg.jdDayFrac(), &jdIntTT, &jdFracTT);
...
template <typename DutContainer>
Time<TimeScale::TCB_SCALE> TimeConverter<DutContainer>::convertTCG_TCB(
    const Time<TimeScale::TCG_SCALE> &tcg) const {
...
template <typename DutContainer>
Time<TimeScale::TDB_SCALE> TimeConverter<DutContainer>::convertTCG_TDB(
    const Time<TimeScale::TCG_SCALE> &tcg) const {
...
template <typename DutContainer>
Time<TimeScale::UTC_SCALE> TimeConverter<DutContainer>::convertTCB_UTC(
    const Time<TimeScale::TCB_SCALE> &tcb) const {
...
template <typename DutContainer>
Time<TimeScale::UT1_SCALE> TimeConverter<DutContainer>::convertTCB_UT1(
    const Time<TimeScale::TCB_SCALE> &tcb) const {
...
template <typename DutContainer>
Time<TimeScale::TAI_SCALE> TimeConverter<DutContainer>::convertTCB_TAI(
    const Time<TimeScale::TCB_SCALE> &tcb) const {
...
template <typename DutContainer>
Time<TimeScale::TT_SCALE> TimeConverter<DutContainer>::convertTCB_TT(
    const Time<TimeScale::TCB_SCALE> &tcb) const {
...
template <typename DutContainer>
Time<TimeScale::TCG_SCALE> TimeConverter<DutContainer>::convertTCB_TCG(
    const Time<TimeScale::TCB_SCALE> &tcb) const {
...
template <typename DutContainer>
Time<TimeScale::TDB_SCALE> TimeConverter<DutContainer>::convertTCB_TDB(
    const Time<TimeScale::TCB_SCALE> &tcb) const {

  scalar jdIntTDB, jdFracTDB;

  const int status =
      iauTcbtdb(tcb.jdDayInt(), tcb.jdDayFrac(), &jdIntTDB, &jdFracTDB);
...
template <typename DutContainer>
Time<TimeScale::UTC_SCALE> TimeConverter<DutContainer>::convertTDB_UTC(
    const Time<TimeScale::TDB_SCALE> &tdb) const {
...
template <typename DutContainer>
Time<TimeScale::UT1_SCALE> TimeConverter<DutContainer>::convertTDB_UT1(
    const Time<TimeScale::TDB_SCALE> &tdb) const {
...
template <typename DutContainer>
Time<TimeScale::TAI_SCALE> TimeConverter<DutContainer>::convertTDB_TAI(
    const Time<TimeScale::TDB_SCALE> &tdb) const {
...
template <typename DutContainer>
Time<TimeScale::TT_SCALE> TimeConverter<DutContainer>::convertTDB_TT(
    const Time<TimeScale::TDB_SCALE> &tdb) const {

  scalar jdIntTT = tdb.jdDayInt(), jdFracTT = tdb.jdDayFrac();
  for (indexType i = 0; i < 3; ++i) {
    const int status = iauTdbtt(
        tdb.jdDayInt(), tdb.jdDayFrac(),
        dtr(Time<TimeScale::TT_SCALE>(jdIntTT, jdFracTT)), &jdIntTT, &jdFracTT);
...
template <typename DutContainer>
Time<TimeScale::TCG_SCALE> TimeConverter<DutContainer>::convertTDB_TCG(
    const Time<TimeScale::TDB_SCALE> &tdb) const {
...
template <typename DutContainer>
Time<TimeScale::TCB_SCALE> TimeConverter<DutContainer>::convertTDB_TCB(
    const Time<TimeScale::TDB_SCALE> &tdb) const {

  scalar jdIntTCB, jdFracTCB;

  const int status =
      iauTdbtcb(tdb.jdDayInt(), tdb.jdDayFrac(), &jdIntTCB, &jdFracTCB);
