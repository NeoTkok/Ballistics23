...
TEST(ACCELERATION, ALL) {
  ...
  const Ballistics23::FrameModule::FrameConverter<
      Ballistics23::FrameModule::PolarMotionContainer,
      Ballistics23::TimeModule::DutContainer>
  ...
  const Ballistics23::Force::EarthGravityForce earthGravity(earthPath, "egm96",
                                                            4, 4);
  ...
  const Ballistics23::Force::AccelerationCalculator accelerationCalculator(
      timeConverter, frameConverter, ephemerisCalculator, earthGravity,
      forcesTuple);
  ...
  const Ballistics23::Vector3d acceleration =
      accelerationCalculator.calcAcceleration(earthGravity, forcesTuple, timeTT,
