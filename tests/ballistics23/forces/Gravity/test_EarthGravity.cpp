    ...
    for (int i = 0; i < 177; i++) {
        ...
        for (int m = 0; m < 100; m++) {
            for (int n = 0; n < 100; n++) {
                ...
                const V3d r = R * V3d(std::sin(Tet) * std::cos(Phi), std::sin(Tet) * std::sin(Phi), std::cos(Tet));
                ...
                const V3d acceleration128x128 = earthGravity128x128.calcAccelerationECEF(r);
        ...
        myfile << " " << R << " " << meanDiffByR1122 / 10000 << " " << meanDiffByR2233 / 10000 << " "
               << meanDiffByR128x64 / 10000 << " " << meanDiffByR128x32 / 10000 << " " << meanDiffByR128x16 / 10000
