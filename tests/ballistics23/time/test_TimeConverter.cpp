...
TEST(CONVERT, UTC_UT1_TAI) {
    ...
    const Ballistics23::Containers::vector<Ballistics23::scalar> dutValues = {
        -0.0320059, -0.0330198, -0.0340678, -0.0351611, -0.0361345, -0.0370076, -0.0377478};
    ...
    const Time<TimeScale::UTC_SCALE> utc(Ballistics23::timeResult[0][3], Ballistics23::timeResult[0][4]);
    ...
    const Time<TimeScale::UT1_SCALE> ut1_reference(Ballistics23::timeResult[0][1], Ballistics23::timeResult[0][2]);
    const Time<TimeScale::TAI_SCALE> tai_reference(Ballistics23::timeResult[0][5], Ballistics23::timeResult[0][6]);
...
TEST(CONVERT, MPI_UT1_UTC) {
    ...
    const Time<TimeScale::UTC_SCALE> utc_reference(Ballistics23::timeResult[0][3], Ballistics23::timeResult[0][4]);

    const Time<TimeScale::UT1_SCALE> ut1(Ballistics23::timeResult[0][1], Ballistics23::timeResult[0][2]);
...
TEST(CONVERT, TT_TDB) {
    ...
    const Time<TimeScale::TDB_SCALE> tdb_reference(Ballistics23::timeResult[0][13], Ballistics23::timeResult[0][14]);

    const Time<TimeScale::TT_SCALE> tt(Ballistics23::timeResult[0][7], Ballistics23::timeResult[0][8]);
...
TEST(CONVERT, TDB_TT_MPI) {
    ...
    const Time<TimeScale::TDB_SCALE> tdb(Ballistics23::timeResult[0][13], Ballistics23::timeResult[0][14]);

    const Time<TimeScale::TT_SCALE> tt_reference(Ballistics23::timeResult[0][7], Ballistics23::timeResult[0][8]);
...
TEST(CONVERT, ALL) {
    ...
    const Ballistics23::Containers::vector<TimeScale> scales = {
        TimeScale::UT1_SCALE, TimeScale::UTC_SCALE, TimeScale::TAI_SCALE, TimeScale::TT_SCALE,
        TimeScale::TCG_SCALE, TimeScale::TCB_SCALE, TimeScale::TDB_SCALE};
