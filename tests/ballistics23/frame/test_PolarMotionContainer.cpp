...
using Time = Ballistics23::TimeModule::Time<Scale>;

TEST(INTERPOLATOR, MID_POINTS) {
    const Ballistics23::Containers::vector<scalar> xpValues = {
        0.095386, 0.093289, 0.090829, 0.088414, 0.086360, 0.084450, 0.081750, 0.079016, 0.076411, 0.074159, 0.072162};

    const Ballistics23::Containers::vector<scalar> ypValues = {
        0.268935, 0.269801, 0.270475, 0.270763, 0.271107, 0.272019, 0.272569, 0.272577, 0.272536, 0.272895, 0.273364};
    ...
    const Ballistics23::FrameModule::PolarMotionContainer polarMotionContainer(timePointsMJD_UTC, xpValues, ypValues);
    ...
    for (Ballistics23::indexType i = 0; i < xpValues.size() - 1; ++i) {
        ...
        const Time<Ballistics23::TimeModule::TimeScale::UTC_SCALE> utc =
            Time<Ballistics23::TimeModule::TimeScale::UTC_SCALE>::buildFromMJD(midPointMJD_UTC);

        ASSERT_DOUBLE_EQ(utc.mjd(), midPointMJD_UTC);

        const Ballistics23::FrameModule::PolarMotion polarMotion = polarMotionContainer.getPolarMotion(utc);
